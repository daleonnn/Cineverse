...
<head>
    ...
    <title>Editar Sala - CineAdmin</title>
...
<body>
    <div class="container">
        <h1>
            ...
            <span class="sala-id">ID: <?= $sala['id_sala'] ?></span>
        </h1>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="capacidad" name="capacidad" min="1" value="<?= htmlspecialchars($sala['capacidad']) ?>" required>
                <p class="capacity-info">Actualice la cantidad total de asientos disponibles en esta sala</p>
            </div>
