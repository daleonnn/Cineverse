...
<head>
    ...
    <title>Editar Función - CineAdmin</title>
...
<body>
    <div class="container">
        <h2><i class="fas fa-edit"></i> Editar Función #<?= $funcion['id_funcion'] ?></h2>
        ...
        <form action="../../api/funciones/update_funcion.php" method="POST">
            ...
            <div class="form-group price-input">
                ...
                <input type="number" name="precio" id="precio" min="0" step="1000" value="<?= $funcion['precio'] ?? '10000' ?>" required>
            </div>
            
            <div class="form-group">
                <label for="fecha_hora">Fecha y Hora</label>
                <input type="datetime-local" name="fecha_hora" id="fecha_hora" value="<?= date('Y-m-d\TH:i', strtotime($funcion['fecha_hora'])) ?>" required>
                <span class="info-badge"><?= date('d/m/Y H:i', strtotime($funcion['fecha_hora'])) ?></span>
            </div>
